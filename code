...
#       and we have sinc4 or sinc3 filter. This function reads FS[10:0] from the first enabled channel register.
...
def real_sampling_rate():
    reg = ad7124._ctrl.reg_read(ad7124.rx_enabled_channels[0]) 
    fs = reg % (2**11) # FS[10: 0]
